const adjectives = [
  ...
  , "Better", "Bewildered", "Black", "Fantastic", "Fierce", "Filthy", "Nutty", "Obedient", "Obnoxious", "Uptight", "Vast", "Victorious", "Silly", "Condemned", "Confused",
...
const animals = [
  ...
  "Ibexes", "Zebras", "Ducks", "Beavers", "Orangutans", "Mice", "Iguanass", "Jaguars", "Elephants", "Badgers", "Giraffes", "Vultures", "Jellyfishs", "Lizards", "Fish",
