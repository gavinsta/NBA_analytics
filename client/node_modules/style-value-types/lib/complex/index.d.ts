import { Color } from 'style-value-types/lib/types';
declare function test(v: any): boolean;
declare function parse(v: string | number): (number | import("style-value-types/lib/types").RGBA | import("style-value-types/lib/types").HSLA)[];
